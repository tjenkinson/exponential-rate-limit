 ...
 */
export interface JobMetadata { enqueueTime: number; }
/**
 ...
 */
export type Job = (jobMetadata: JobMetadata) => Promise<boolean> | boolean | void;
 ...
 */
export type DelayFunction = (x: number, maxDelay: number) => number;

export interface JobHolder { job: Job; metadata: JobMetadata; }
